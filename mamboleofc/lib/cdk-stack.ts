...
const siteDomainStage = 'stage.mamboleofc.ca';
const siteDomainProduction = 'www.mamboleofc.ca';
const domainProduction = 'mamboleofc.ca';
const mediaDomain = 'media.mamboleofc.ca';
const hostId = cdk.Fn.importValue('MamboleoFCHostZoneId')
const zoneName = cdk.Fn.importValue('MamboleoFCHostZoneName')

const certificateDomain = '*.mamboleofc.ca';
...
export class SiteCdkStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const myHostedZone = route53.HostedZone.fromHostedZoneAttributes(this, 'Route53Zone', { hostedZoneId: hostId, zoneName:zoneName })
  ...
  //  const myZone = route53.HostedZone.fromHostedZoneAttributes(this, 'Route53TomvisionsZone', { hostedZoneId: 'Z2L2Y9R9WT05A6', zoneName: 'tomvisions.com' })
    ...
    const distributionMedia = new cloudfront.Distribution(this, 'MediaSiteDistribution', {
      ...
      defaultBehavior: {
        origin: new cloudfront_origins.S3Origin(siteBucketMedia, { originAccessIdentity: cloudfrontOAI }),
        compress: true,
    ...
    const distributionStage = new cloudfront.Distribution(this, 'StageSiteDistribution', {
      ...
      comment: "Distribution for MamboLeoFC Staging"
    })
        ...
        const distributionProduction = new cloudfront.Distribution(this, 'ProductionSiteDistribution', {
          ...
          comment: "Distribution for MamboLeoFC Production"
        })
    ...
    const route53media = new route53.ARecord(this, 'Route53AliasSiteMedia', {
      zone: myHostedZone,
      target: route53.RecordTarget.fromAlias(new CloudFrontTarget(distributionMedia)),
      recordName: 'media'
    })
