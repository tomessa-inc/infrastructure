...
const mediaBucketArn  = cdk.Fn.importValue('bucketOutput-media-mamboleofc-ca-Arn')
const stageBucketArn  = cdk.Fn.importValue('bucketOutput-stage-mamboleofc-ca-Arn')
const wwwBucketArn  = cdk.Fn.importValue('bucketOutput-www-mamboleofc-ca-Arn')
...
*/
        this.generateBucketComponent('images.mamboleofc.ca');
        this.generateBucketComponent('media.mamboleofc.ca');
        this.generateBucketComponent('stage.mamboleofc.ca');
        this.generateBucketComponent('www.mamboleofc.ca');
        this.generateBucketComponent('mamboleofc-api-stage');
        this.generateBucketComponent('mamboleofc-api-production');
        this.generateBucketComponent('admin.mamboleofc.ca');
