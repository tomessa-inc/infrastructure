...
const distributionMedia = {id: cdk.Fn.importValue(`distributionId-media-scheduler-page`), name:cdk.Fn.importValue(`distributionDomainName-media-scheduler-page`) }
const distributionStage = {id: cdk.Fn.importValue(`distributionId-stage-scheduler-page`), name:cdk.Fn.importValue(`distributionDomainName-stage-scheduler-page`) }
const distributionWww = {id: cdk.Fn.importValue(`distributionId-www-scheduler-page`), name:cdk.Fn.importValue(`distributionDomainName-www-scheduler-page`) }
...
*/
    ...
    generateCachePolicy() {
        ...
        this._cachePolicy = new aws_cloudfront.CachePolicy(this, 'cachePolicyCloudfront', {
            cachePolicyName: 'scheduler-year-policy',
    ...
    async initialize() {
        ...
        await this.generateComponent('www.scheduler.page', "www")
        await this.generateComponent('stage.scheduler.page',  "stage")
    }
