...
import {KOFCCICDCdkStack} from "../lib/cicd-pipeline-stack";
...
import {CicdMemberPipelineStack} from "../lib/cicd-member-pipeline-stack";
import {CicdGolfPipelineStack} from "../lib/cicd-golf-pipeline-stack";
...
new KOFCCICDCdkStack(app, 'KOFCCICDCdkStack', {
    /* If you don't specify 'env', this stack will be environment-agnostic.
     * Account/Region-dependent features and context lookups will not work,
     * but a single synthesized template can be deployed anywhere. */
...
new CicdMemberPipelineStack(app, 'CicdMemberPipelineStack', {
    /* If you don't specify 'env', this stack will be environment-agnostic.
     * Account/Region-dependent features and context lookups will not work,
     * but a single synthesized template can be deployed anywhere. */
...
new CicdGolfPipelineStack(app, 'CicdGolfPipelineStack', {
    /* If you don't specify 'env', this stack will be environment-agnostic.
     * Account/Region-dependent features and context lookups will not work,
     * but a single synthesized template can be deployed anywhere. */
