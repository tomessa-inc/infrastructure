...
const sourceArtifact = new codepipeline.Artifact("SourceArtifactMember");

const buildArtifactStage = new codepipeline.Artifact("buildArtifactStageMember");
const buildArtifactProduction = new codepipeline.Artifact("buildArtifactProductionMember");

const projectName = 'kofc-admin'

export class CicdMemberPipelineStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const buildStage = {
            ...
            actions: [
                new pipelineactions.CodeBuildAction({
                    ...
                    project: CodeBuildCdkStack.getCodebuild(this, "member-stage", "member-stage.kofc9544.ca"),
        ...
        const deployStage = {
            ...
            actions: [
                new pipelineactions.S3DeployAction({
                    actionName: 'S3Deploy',
                    bucket: S3BucketStack.getS3Bucket(this, 'member-stage.kofc9544.ca', "pipeline-member-stage"),
        ...
        const buildProduction = {
            ...
            actions: [
                new pipelineactions.CodeBuildAction({
                    actionName: "CodeBuild",
                    input: sourceArtifact,
                    project: CodeBuildCdkStack.getCodebuild(this, "member", "member.kofc9544.ca"),
        ...
        const deployProduction = {
            ...
            actions: [
                new pipelineactions.S3DeployAction({
                    actionName: 'S3Deploy',
                    bucket: S3BucketStack.getS3Bucket(this, 'member.kofc9544.ca', "pipeline-member"),
                    input: buildArtifactStage
                })]
        }
        ...
        const pipelineAPI = new codepipeline.Pipeline(this, "CICDCdkStack", {
            pipelineName: "member-pipeline",
            stages: [sourceStage,  buildStage, deployStage, Approval, buildProduction, deployProduction],
            artifactBucket: S3BucketStack.generateDynamicS3Bucket(this, "code-pipeline-member-767397839074"),
